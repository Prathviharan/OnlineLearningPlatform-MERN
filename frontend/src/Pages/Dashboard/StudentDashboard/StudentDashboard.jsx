...
import { NavLink, useParams, useNavigate } from 'react-router-dom'//import NavLink, useParams, useNavigate
import teachingImg from '../../Images/Teaching.svg'//import teachingImg
    ...
    {/* navigation bar */}
      ...
      <div className='bg-[#008280] flex justify-between items-center'>
        <div className=' text-white font-semibold text-5xl ml-72'>
          <h1 className='mb-5 text-[#071645]'>Welcome to <span className='text-white'>Learnify</span></h1>
