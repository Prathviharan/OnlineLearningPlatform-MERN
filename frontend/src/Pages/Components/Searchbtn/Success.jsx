  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center'>
        <div className='flex flex-col items-center gap-5 p-5 justify-center h-80 w-92 rounded-md bg-green-500 text-white'>
            ...
            <h1 className=' text-xl text-green-900 font-semibold'>Enrollment is Successful</h1>
            <p className='text-center text-gray-900'>Enrollment is successfully completed! Now you can join the classes. and explore the course <br />Wishing a happy journey with Learnify
            </p>
